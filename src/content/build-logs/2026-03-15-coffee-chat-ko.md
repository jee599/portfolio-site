---
title: "Claude Code 프로젝트 6세션 기록: 에이전트 10명으로 AI 멘토링 플랫폼 만들기"
project: "coffee-chat"
date: 2026-03-15
lang: ko
tags: [claude-code, multi-agent, nextjs, toss-payments]
description: "Claude Code 프로젝트로 AI 멘토링 플랫폼을 만들었다. 에이전트 10명 병렬 실행, 1289번의 tool call, 토스 결제 연동까지 6세션의 전 과정을 기록한다."
---
...
커피챗은 게임 업계 현직 개발자와 멘티를 연결하는 1:1 AI 멘토링 플랫폼이다. 기술 스택은 Next.js 16, Supabase, Toss Payments, Resend. 처음에는 거의 빈 껍데기였다. 의존성도 안 깔려 있고, `.env.example`도 없고, README는 create-next-app 기본 템플릿이었다.
